...
import BookingWidget from "../pageComponents/BookingWidget";
import PublicPlaceGallery from "../pageComponents/PublicPlaceGallery";
import AddressLink from "../pageComponents/AddressLink";
...
export default function PublicPlacePage() {
  ...
  return (
    <div className="mt-4 bg-gray-100 -mx-8 px-8 py-8">
      ...
      <PublicPlaceGallery place={place} />
