          ...
          addedPhotos.map((link, index) => (
            <div key={index} className="h-32 flex relative">
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 text-white bg-opacity-50 bg-black p-1 rounded-2xl"
              >
                <svg
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 left-1 text-white bg-opacity-50 bg-black p-1 rounded-2xl"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
